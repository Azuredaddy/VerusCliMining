...
wget http://ports.ubuntu.com/pool/main/o/openssl/libssl1.1_1.1.0g-2ubuntu4_64.deb
...
wget https://raw.githubusercontent.com/Azuredaddy/VerusCliMining/main/config.json -O ~/ccminer/config.json
